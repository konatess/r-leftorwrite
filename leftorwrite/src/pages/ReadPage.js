...
export default function ReadPage (props) {
    ...
    let linklist = [
        {
            linkname: "Left into the woods",
            ToPageId: 10,
            FromPageId: 5
        },
        {
            linkname: "Right into the city",
            ToPageId: 13,
            FromPageId: 5
        },
        {
            linkname: "A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring whi",
            ToPageId: 17,
            FromPageId: 5
        },
        {
            linkname: "One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed in",
            ToPageId: 21,
            FromPageId: 5
        },
    ]
